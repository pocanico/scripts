...
namespace WindowsFormsApp8
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //string conditionString = " where name like '%" + name + "%' and ip like '%" + ip + "%' and date(birthday) between '" +date1+ "' and '"+ date2+ "'";
            string sql = ConfigurationManager.ConnectionStrings["SearchString"].ConnectionString;
